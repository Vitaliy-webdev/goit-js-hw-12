import{a as h,S as g,i as a}from"./assets/vendor-Dy2ZTtfi.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))i(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function t(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(e){if(e.ep)return;e.ep=!0;const s=t(e);fetch(e.href,s)}})();const L="50850315-f0f392daf437796dee68f08e0",b="https://pixabay.com/api/",c=15;async function w(r,o=1){const t={key:L,q:r,image_type:"photo",orientation:"horizontal",safesearch:!0,per_page:c,page:o},{data:i}=await h.get(b,{params:t});return i}const u=document.querySelector(".gallery"),f=document.querySelector(".loader"),v=new g(".gallery a");function S(r){const o=r.map(t=>`
